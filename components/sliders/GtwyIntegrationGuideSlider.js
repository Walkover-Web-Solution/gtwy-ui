...
function GtwyIntegrationGuideSlider({ data, handleCloseSlider }) {
  ...
  const [embedToken, setEmbedToken] = useState(
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJvcmdfaWQiOiI1ODQ2MyIsImZvbGRlcl9pZCI6IjY5ODVkMjA0MWQyOWE5YTIyMzIxYWZlMiIsInVzZXJfaWQiOiJZb3VyX3VzZXJfaWQifQ.ruv0hbR9-kRfOH8qft6DIBL9SvN4Xgwuw3p4luhHsN8"
  );

  useEffect(() => {
    const generateEmbedToken = async () => {
      if (!data?.org_id || !data?.embed_id) {
        setEmbedToken(
          "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJvcmdfaWQiOiI1ODQ2MyIsImZvbGRlcl9pZCI6IjY5ODVkMjA0MWQyOWE5YTIyMzIxYWZlMiIsInVzZXJfaWQiOiJZb3VyX3VzZXJfaWQifQ.ruv0hbR9-kRfOH8qft6DIBL9SvN4Xgwuw3p4luhHsN8"
        );
        return;
